...
struct MAPMT_PIXEL{
	...
	MAPMT_PIXEL(Int_t a=-1, Int_t b=-1, Double_t c=-1.0, Double_t d=1.0, Double_t e=0.0, Int_t f=-1, Int_t g=-1, Double_t h=0.0, Double_t i=0.0) : nPixelId(a), nQdcChannelId(b), fAmplitude(c), fGain(d), fThreshold(e), nPixelRow(f), nPixelCol(g), fX(h), fY(i) {} // standard constructor
